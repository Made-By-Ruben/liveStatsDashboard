<script lang="ts">
	...
	let {goldDiff, winningTeam, visualStyle}: { goldDiff: GoldDiffGraph; winningTeam: 100 | 200 | null; visualStyle: string | undefined } = $props();
	...
	function getColor(team: 100 | 200) {
		if (team === winningTeam) {
			return visualStyle === 'ROL' ? '#d3fe31' : '#EFBF04'
		}
		else return '#FFFFFF'
	}
</script>
